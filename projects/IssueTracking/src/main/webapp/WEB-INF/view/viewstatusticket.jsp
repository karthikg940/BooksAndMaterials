...
<body onLoad="noBack();" onpageshow="if (event.persisted) noBack();">
			...
			<div class="container-fluid">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="<spring:url value="/user/home"></spring:url>">
	...
	<div class="container">
		<div class="jumbotron">
					...
					<div class="col-md-6 col-md-offset-3">
						<div class="panel panel-login">
							<div class="panel-heading">
								<div class="row">
									<div class="col-xs-12">
										<a href="#" class="active" id="login-form-link">Search
											Ticket By Id</a>
									</div>
								</div>
								<hr>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<spring:url value="/user/viewStatusById" var="path"></spring:url>
										<form id="login-form" name="myform" method="POST"
											action="${path}" onsubmit="return searchTicketById()">

											<div class="form-group">
												<input type="text" name="ticketId" id="ticketId"
													tabindex="1" class="form-control" placeholder="Ticket Id"
													value=""> <span id="spanticketId"
					...
					<div class="col-md-6 col-md-offset-3">
						<div class="panel panel-login">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<spring:url value="/user/viewStatusByCategory" var="path2"></spring:url>
										<form:form id="login-form" name="myform" method="POST"
											action="${path2}" modelAttribute="ticket"
											onsubmit="return searchTicketByCategory()">
			...
			<div>
				<spring:url value="/user/viewStatusByAll" var="path3"></spring:url>
				<form:form id="login-form" name="myform" method="POST"
					action="${path3}" modelAttribute="ticket">
					<div class="form-group">
						<div class="row">
